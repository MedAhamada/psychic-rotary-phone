  ...
  it('should render with success type and icon', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          onCloseMock = jest.fn();
          _render = render( /*#__PURE__*/React.createElement(Alert, {
            type: "success",
            title: 'Success Alert',
            ...
            onClose: onCloseMock,
            position: 'fixed'
          })), baseElement = _render.baseElement, getByTestId = _render.getByTestId, getByLabelText = _render.getByLabelText, getByText = _render.getByText;
  ...
  it('should render with warning type and icon', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          onCloseMock = jest.fn();
          _render2 = render( /*#__PURE__*/React.createElement(Alert, {
            type: "warning",
            title: 'Warning Alert',
            ...
            onClose: onCloseMock,
            position: 'fixed'
          })), baseElement = _render2.baseElement, getByTestId = _render2.getByTestId, getByLabelText = _render2.getByLabelText, getByText = _render2.getByText;
          expect(baseElement).toBeTruthy();
          _context2.next = 5;
          return waitFor(function () {
  ...
  it('should render with danger type and icon', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          onCloseMock = jest.fn();
          _render3 = render( /*#__PURE__*/React.createElement(Alert, {
            type: "danger",
            title: 'Danger Alert',
            ...
            onClose: onCloseMock,
            position: 'fixed'
          })), baseElement = _render3.baseElement, getByTestId = _render3.getByTestId, getByLabelText = _render3.getByLabelText, getByText = _render3.getByText;
          expect(baseElement).toBeTruthy();
          _context3.next = 5;
          return waitFor(function () {
