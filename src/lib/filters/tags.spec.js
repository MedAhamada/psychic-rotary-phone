  ...
  it('applies tags filters', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _render = render( /*#__PURE__*/React.createElement(Tags, defaultProps)), baseElement = _render.baseElement, getByText = _render.getByText, getByTestId = _render.getByTestId, getAllByRole = _render.getAllByRole;
  ...
  it('resets tags filters', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _render2 = render( /*#__PURE__*/React.createElement(Tags, defaultProps)), baseElement = _render2.baseElement, getByText = _render2.getByText, getByTestId = _render2.getByTestId, getAllByRole = _render2.getAllByRole;
          expect(baseElement).toBeTruthy();
          _context2.next = 4;
          return waitFor(function () {
            return getByTestId('open-test-tags-filter');
