      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _render2 = render( /*#__PURE__*/React.createElement(Pagination, {
            ...
            resultText: 'results',
            entriesText: 'entries per page'
          })), baseElement = _render2.baseElement, getByText = _render2.getByText, getByLabelText = _render2.getByLabelText;
          expect(baseElement).toBeTruthy();
          _context2.next = 5;
          return waitFor(function () {
      ...
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _render3 = render( /*#__PURE__*/React.createElement(Pagination, {
            ...
            resultText: 'results',
            entriesText: 'entries per page'
          })), baseElement = _render3.baseElement, getByText = _render3.getByText, getByLabelText = _render3.getByLabelText;
          expect(baseElement).toBeTruthy();
          _context3.next = 5;
          return waitFor(function () {
            return getByLabelText('pagination previous');
      ...
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _render4 = render( /*#__PURE__*/React.createElement(Pagination, {
            ...
            resultText: 'results',
            entriesText: 'entries per page'
          })), baseElement = _render4.baseElement, getByText = _render4.getByText, getByLabelText = _render4.getByLabelText;
          expect(baseElement).toBeTruthy();
          _context4.next = 5;
          return waitFor(function () {
      ...
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _render5 = render( /*#__PURE__*/React.createElement(Pagination, {
            ...
            resultText: 'results',
            entriesText: 'entries per page'
          })), baseElement = _render5.baseElement, getByText = _render5.getByText;
          expect(baseElement).toBeTruthy();
          _context5.next = 5;
          return waitFor(function () {
            return getByText('3');
      ...
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _render6 = render( /*#__PURE__*/React.createElement(Pagination, {
            ...
            entriesText: 'entries per page',
            entriesPerPage: true
          })), baseElement = _render6.baseElement, getByText = _render6.getByText, getByLabelText = _render6.getByLabelText, getByTestId = _render6.getByTestId;
          expect(baseElement).toBeTruthy();
          _context6.next = 5;
          return waitFor(function () {
  ...
  it('renders correct page buttons based on maxVisiblePages', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          mockOnChange = jest.fn();
          _render7 = render( /*#__PURE__*/React.createElement(Pagination, {
            currentPage: 5,
            total: 100,
            pageSize: 10,
            onChange: mockOnChange,
            ...
            entriesText: 'entries per page',
            entriesPerPage: true
          })), baseElement = _render7.baseElement, getByText = _render7.getByText, getAllByLabelText = _render7.getAllByLabelText;
          expect(baseElement).toBeTruthy();
          _context7.next = 5;
          return waitFor(function () {
            return getByText('1');
  ...
  it('renders correct number of entries in the middle of the page range', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          mockOnChange = jest.fn();
          _render8 = render( /*#__PURE__*/React.createElement(Pagination, {
            currentPage: 6,
            total: 100,
            pageSize: 10,
            onChange: mockOnChange,
            ...
            entriesText: 'entries per page',
            entriesPerPage: true
          })), baseElement = _render8.baseElement, getByText = _render8.getByText;
          expect(baseElement).toBeTruthy();
          _context8.next = 5;
          return waitFor(function () {
