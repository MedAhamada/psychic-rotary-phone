  ...
  it('should render a table element with thead and tbody', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _render = render( /*#__PURE__*/React.createElement(Table, props)), baseElement = _render.baseElement, getByTestId = _render.getByTestId, getAllByRole = _render.getAllByRole;
            ...
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(column) {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    if (column.sorting) {
                      sortingButton = getByTestId("sorting-button-".concat(column.accessor));
                    ...
                    dateFilter = getByTestId("open-".concat(column.accessor, "-date-filter"));
                    expect(dateFilter).toBeTruthy();
                    fireEvent.click(dateFilter);
                    _context.next = 7;
                    return waitFor(function () {
                      return expect(getByTestId("".concat(column.accessor, "-date-filter"))).toBeTruthy();
                    });
                  case 7:
                    _context.next = 23;
                    break;
                  case 9:
                    ...
                    rangeFilter = getByTestId("open-".concat(column.accessor, "-range-filter"));
                    expect(rangeFilter).toBeTruthy();
                    fireEvent.click(rangeFilter);
                    _context.next = 15;
                    return waitFor(function () {
                      return expect(getByTestId("".concat(column.accessor, "-range-filter"))).toBeTruthy();
                    });
                  case 15:
                    _context.next = 23;
                    break;
                  case 17:
                    ...
                    tagsFilter = getByTestId("open-".concat(column.accessor, "-tags-filter"));
                    expect(tagsFilter).toBeTruthy();
                    fireEvent.click(tagsFilter);
                    _context.next = 23;
                    return waitFor(function () {
                      return expect(getByTestId("".concat(column.accessor, "-tags-filter"))).toBeTruthy();
                    });
                  case 23:
                    th = getByTestId("th-".concat(column.accessor));
          ...
          data.forEach(function (item, i) {
            var tr = getByTestId("tr-".concat(i));
            expect(tr).toBeTruthy();
            columns.forEach(function (column) {
              var td = getByTestId("td-".concat(column.accessor, "-").concat(i));
